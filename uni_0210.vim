...
com! SetpathSilent let &l:path .= GetPrjRootPath() . GetIncPath()
com! SetpathSilent let &l:path .= '.,' . GetIncPath() . GetPrjRootPath()
...
function! MakeTags()
  ...
  if 0  " UTF-8
    ...
    let s:mk_tag_job = job_start('sh -c "cd `git rev-parse --show-toplevel && git rev-parse --show-toplevel` && echo '!_TAG_FILE_ENCODING	CP932' > tags_tmp && ctags -Rf tags_tmp && mv tags_tmp tags && awk ' . "'{ print $1 }'" . ' tags > tag_only"')
  endif
  let s:mk_tag_exe = 1
endfunction
...
# print "~/vimfiles/new.vim"
  ...
  print "~/vimfiles/pack/mypackage/opt/nerdtree-master/nerdtree_plugin/vcs.vim"
# print "~/vimfiles/new.vim"
...
let &cpo = s:save_cpo
unlet s:save_cpo
"+++++ ~/vimfiles/pack/mypackage/opt/nerdtree-master/nerdtree_plugin/vcs.vim ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
" ============================================================================
" File:        vcs.vim
