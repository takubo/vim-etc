...
" TODO
" WinWrapMoveでは、”前の”Windowが、意図しないものになるので、NERDTreeで意図しないWindowで開かれてしまう。
"	一旦、行き先を覚えて、一度戻って、再度"w 数値"で動くことにする。
" Diff Specialの判定では、NERDTreeのWindowを無視して、2個ならDiffするようにする。おなじくTerminalも。
"+++++ colors/Rimpa.vim ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
scriptencoding utf-8
