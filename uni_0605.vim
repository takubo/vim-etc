...
if 1  " HHKB
  nnoremap <silent><expr> <F9>  ':<C-u>se transparency=' .    ( &transparency + 1      ) . '<Bar> Transparency <CR>'
  nnoremap <silent><expr> <F10> ':<C-u>se transparency=' . max([&transparency - 1,   1]) . '<Bar> Transparency <CR>'   | " transparencyは、0以下を設定すると255になってしまう。

  nnoremap <silent>       <F11> :exe 'se transparency=' . (&transparency == g:my_transparency ? 255 : g:my_transparency) <Bar> Transparency <CR>
  nnoremap <silent>       <F12> :exe 'se transparency=' . (&transparency == g:my_transparency ?  50 : g:my_transparency) <Bar> Transparency <CR>
endif
...
" HHKB
nnoremap <A-q>	:<C-u>call ResizeFont(+0.5)<CR>:Font<CR>
nnoremap <A-w>	:<C-u>call ResizeFont(-0.5)<CR>:Font<CR>
nnoremap <A-e>	:<C-u>call ResizeFont(0)<CR>:Font<CR>
nnoremap <A-r>	:<C-u>call ResizeFont(-99999)<CR>:Font<CR>
